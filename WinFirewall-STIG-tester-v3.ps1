...
if ($origValue -eq 1) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241989 - Corrected firewall state to on; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles state on | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241990 - Corrected firewall state to on; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles state on | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241991 - Corrected firewall state to on; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241992 - Corrected inbound action; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 0) {
    ...
    netsh advfirewall set allprofiles firewallpolicy blockinbound,allowoutbound | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241993 - Corrected outbound action; original value was $origValue"
}
$results += $row
...
if ($origValue -ge 16384) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241994 - Corrected LogFileSize to 16384; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241995 - Corrected dropped connections logging; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241996 - Corrected allowed connections logging; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles firewallpolicy blockinbound,allowoutbound | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241997 - Corrected standard profile inbound action; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 0) {
    ...
    netsh advfirewall set allprofiles firewallpolicy blockinbound,allowoutbound | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241998 - Corrected standard profile outbound action; original value was $origValue"
}
$results += $row
...
if ($origValue -ge 16384) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-241999 - Corrected PrivateProfile LogFileSize to 16384; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles logging droppedconnections enable | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242000 - Corrected dropped connections logging for PrivateProfile; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles logging allowedconnections enable | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242001 - Corrected allowed connections logging for PrivateProfile; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles firewallpolicy blockinbound,allowoutbound | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242002 - Corrected PublicProfile inbound action; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 0) {
    ...
    netsh advfirewall set allprofiles firewallpolicy blockinbound,allowoutbound | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242003 - Corrected PublicProfile outbound action; original value was $origValue"
}
$results += $row
...
if ($origValue -ge 16384) {
    ...
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242006 - Corrected PublicProfile LogFileSize to 16384; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles logging droppedconnections enable | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242007 - Corrected PublicProfile dropped packets logging; original value was $origValue"
}
$results += $row
...
if ($origValue -eq 1) {
    ...
    netsh advfirewall set allprofiles logging allowedconnections enable | Out-Null
    $row.corrected = $true
    Add-Content -Path $logFile -Value "$(Get-Date -Format 'MM-dd-yyyy HH:mm'): V-242008 - Corrected PublicProfile allowed connections logging; original value was $origValue"
}
$results += $row
